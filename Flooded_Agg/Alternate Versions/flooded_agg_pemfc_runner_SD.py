...
i_ext2 = np.linspace(0.21,2.0,8)   # external currents further from 0 [A/cm^2]
...
i_find = 1.0        # current from polarization curve to use in i_val verification
...
def dsvdt_func(t, sv, objs, p, iSV):
    ...
    for i in range(cl['Ny'] -1):
        ...
        rho_dot_n = naf_s_ca.get_net_production_rates(naf_b_ca) \
                *naf_b_ca.molecular_weights#*cl['1/eps_n'] *cl['SApv_naf']\
        ...
        dsvdt[iSV['rho_shl_k'] +cl_ymv] = (o2_abs *rho_dot_n*cl['r_agg_tot']**2 - rho_flx_inr)*cl['1/r_j'][0]**2/cl['t_shell']
        ...
        for j in range(cl['Nr'] -1):
            ...
            dsvdt[iMid] = (rho_flx_otr - rho_flx_inr)*cl['1/r_j'][j]**2*cl['1/t_shl'][j] + pt_rxn *rho_dot_n
        ...
        dsvdt[iLast] = (rho_flx_otr - rho_flx_inr)*cl['1/r_j'][-1]**2*cl['1/t_shl'][-1] + pt_rxn *rho_dot_n
