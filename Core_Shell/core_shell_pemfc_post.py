...
if save == 1:
    import core_shell_pemfc_runner as user_inputs
    os.chdir(cwd + '/Core_Shell/Saved_Results')
    SaveFiles(folder_name, 'core_shell', ctifile, p, sv_save, user_inputs)
    os.chdir(cwd + '/Core_Shell/Saved_Results/' + folder_name)
