...
i_ext1 = np.linspace(0.101,2.5,10)  # external currents [A/cm^2]
i_ext2 = np.linspace(2.61,2.621,20) # external currents further from 0 [A/cm^2]
...
" Saving options "
folder_name = 'lam_10nm'     # folder name for saving all files/outputs
