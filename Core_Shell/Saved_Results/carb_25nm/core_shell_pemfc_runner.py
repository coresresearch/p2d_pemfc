...
i_ext1 = np.linspace(0.101,1.0,10)  # external currents [A/cm^2]
i_ext2 = np.linspace(1.01,2.00,10)  # external currents further from 0 [A/cm^2]
...
sig_method = 'mix'   # 'lam', 'bulk', or 'mix' for conductivity method
D_O2_method = 'mix'  # 'lam', 'bulk', or 'mix' for D_O2 method
