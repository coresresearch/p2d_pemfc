...
i_ext1 = np.linspace(0.101,3.2,10)  # external currents [A/cm^2]
i_ext2 = np.linspace(3.2,3.245,20)  # external currents further from 0 [A/cm^2]
...
" Saving options "
folder_name = 'lam_5nm'      # folder name for saving all files/outputs
